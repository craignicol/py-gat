...
def test_fitness():
    assert(bitarray_chromosome([0, 0, 0, 0, 0, 0, 0, 0]).fitness() == 0)
    assert(bitarray_chromosome([0, 0, 0, 0, 0, 0, 0, 1]).fitness() == 1)
    assert(bitarray_chromosome([0, 0, 0, 0, 0, 0, 1, 1]).fitness() == 2)
    assert(bitarray_chromosome([0, 0, 0, 0, 0, 1, 1, 1]).fitness() == 3)
    assert(bitarray_chromosome([0, 0, 0, 1, 1, 1, 1, 0]).fitness() == 4)
    assert(bitarray_chromosome([1, 1, 1, 1, 1, 0, 0, 0]).fitness() == 5)
    assert(bitarray_chromosome([0, 0, 1, 1, 1, 1, 1, 1]).fitness() == 6)
    assert(bitarray_chromosome([1, 1, 1, 1, 1, 0, 1, 1]).fitness() == 7)
    assert(bitarray_chromosome([1, 1, 1, 1, 1, 1, 1, 1]).fitness() == 8)
